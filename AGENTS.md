...
5. **Communication Protocol (Plain English):** Write so the reader understands on the first read: full sentences, everyday words, and a quick explanation of any jargon or acronyms. Be brief by cutting filler and padding — never by chopping sentences into telegraphic fragments. Match the reader's level; if they ask for simpler language or more detail, follow their lead.
